...
for k in rlcs_aux_id:
    ...
    fmpc_strm = ax[0].quiver(gridx[0::2, 0::2], gridy[0::2, 0::2],
                             fmpc_dir_u[0::2, 0::2], fmpc_dir_v[0::2, 0::2],
                             color='tab:blue',
                             scale=5, scale_units='inches',
                             width=0.006)

    rmpc_strm = ax[0].quiver(gridx[0::2, 0::2], gridy[0::2, 0::2],
                             rmpc_dir_u[0::2, 0::2], rmpc_dir_v[0::2, 0::2],
                             color='tab:orange',
                             scale=5, scale_units='inches',
                             width=0.006)
    ax[0].legend([fmpc_strm, rmpc_strm], ['Full-order MPC', 'Reduced-order MPC'],
                 loc='lower left', fontsize=10, framealpha=0.6)

    ax[0].set_xlabel(r'$x_1$')
    ax[0].set_ylabel(r'$x_2$')
    ax[0].set_title('Phase plot comparison \n between full-order and reduced-order MPC', fontsize=15, pad=15)

    ax[1].quiver(state_batch[:, 0], state_batch[0::1, 1],
    ...
    ax[2].quiver(state_batch[0::1, 0], state_batch[0::1, 1],
