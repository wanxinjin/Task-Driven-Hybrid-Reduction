...
# ---------------------------- load the saved data ------------------------
save_dir = 'results'
saved_info = load_data(data_name='res_x20_lam15_rlam5', save_dir=save_dir)
# saved_info = load_data(data_name='res_x30_lam15_rlam3', save_dir=save_dir)
...
for i in range(n_rollout_mpc):
    ...
    analyser.plot_play3(state_lam_traj1=state_lam_traj1,
